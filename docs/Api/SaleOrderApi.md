# SynergiTech\Iplicit\SaleOrderApi

All URIs are relative to https://api.iplicit.com, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**createSaleOrder()**](SaleOrderApi.md#createSaleOrder) | **POST** /api/SaleOrder | Create a sale order. |
| [**getSaleOrder()**](SaleOrderApi.md#getSaleOrder) | **GET** /api/SaleOrder/{id} | Get a sale order |
| [**getSaleOrders()**](SaleOrderApi.md#getSaleOrders) | **GET** /api/SaleOrder | Get sale orders with a search filter |
| [**submitSaleOrder()**](SaleOrderApi.md#submitSaleOrder) | **POST** /api/SaleOrder/{id}/submit | Submit a sale order for authorisation. |
| [**updateSaleOrder()**](SaleOrderApi.md#updateSaleOrder) | **PATCH** /api/SaleOrder/{idOrDocNo} | Update a sale order |


## `createSaleOrder()`

```php
createSaleOrder($domain, $docCreate): string
```
...
$apiInstance = new SynergiTech\Iplicit\Api\SaleOrderApi(
...
try {
    $result = $apiInstance->createSaleOrder($domain, $docCreate);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SaleOrderApi->createSaleOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSaleOrder($id, $domain, $include): \SynergiTech\Iplicit\Model\Doc
```
...
$id = 'id_example'; // string | Id or document number of the sale order
$domain = 'domain_example'; // string | Your assigned domain name. Required for all API requests.
$include = 'include_example'; // string

try {
    $result = $apiInstance->getSaleOrder($id, $domain, $include);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SaleOrderApi->getSaleOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| Id or document number of the sale order | |
| **domain** | **string**| Your assigned domain name. Required for all API requests. | |
...
try {
    $result = $apiInstance->getSaleOrders($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SaleOrderApi->getSaleOrders: ', $e->getMessage(), PHP_EOL;
}
```
...
$id = 'id_example'; // string | Id of the sale order
$domain = 'domain_example'; // string | Your assigned domain name. Required for all API requests.

try {
    $apiInstance->submitSaleOrder($id, $domain);
} catch (Exception $e) {
    echo 'Exception when calling SaleOrderApi->submitSaleOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| Id of the sale order | |
| **domain** | **string**| Your assigned domain name. Required for all API requests. | |
...
```php
updateSaleOrder($idOrDocNo, $domain, $docUpdate)
```
...
$idOrDocNo = 'idOrDocNo_example'; // string | Id or document number of the sale order
$domain = 'domain_example'; // string | Your assigned domain name. Required for all API requests.
$docUpdate = new \SynergiTech\Iplicit\Model\DocUpdate(); // \SynergiTech\Iplicit\Model\DocUpdate

try {
    $apiInstance->updateSaleOrder($idOrDocNo, $domain, $docUpdate);
} catch (Exception $e) {
    echo 'Exception when calling SaleOrderApi->updateSaleOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **idOrDocNo** | **string**| Id or document number of the sale order | |
| **domain** | **string**| Your assigned domain name. Required for all API requests. | |
