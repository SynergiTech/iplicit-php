...
class CatalogApi
{
    ...
    {
        $this->addCatalogItemWithHttpInfo($catalogName, $catalogItemCreate, $contentType);
    }
    ...
    {
        $request = $this->addCatalogItemRequest($catalogName, $catalogItemCreate, $contentType);
    ...
    {
        return $this->addCatalogItemAsyncWithHttpInfo($catalogName, $catalogItemCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->deleteCatalogItemWithHttpInfo($catalogName, $idOrCode, $contentType);
    }
    ...
    {
        $request = $this->deleteCatalogItemRequest($catalogName, $idOrCode, $contentType);
    ...
    {
        return $this->deleteCatalogItemAsyncWithHttpInfo($catalogName, $idOrCode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getCatalogWithHttpInfo($catalogName, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCatalogRequest($catalogName, $contentType);
    ...
    {
        return $this->getCatalogAsyncWithHttpInfo($catalogName, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->lockCatalogItemWithHttpInfo($catalogName, $idOrCode, $catalogItem, $contentType);
    }
    ...
    {
        $request = $this->lockCatalogItemRequest($catalogName, $idOrCode, $catalogItem, $contentType);
    ...
    {
        return $this->lockCatalogItemAsyncWithHttpInfo($catalogName, $idOrCode, $catalogItem, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->replaceCatalogItemsWithHttpInfo($catalogName, $catalogItemCreate, $contentType);
    }
    ...
    {
        $request = $this->replaceCatalogItemsRequest($catalogName, $catalogItemCreate, $contentType);
    ...
    {
        return $this->replaceCatalogItemsAsyncWithHttpInfo($catalogName, $catalogItemCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->unlockCatalogItemWithHttpInfo($catalogName, $idOrCode, $catalogItem, $contentType);
    }
    ...
    {
        $request = $this->unlockCatalogItemRequest($catalogName, $idOrCode, $catalogItem, $contentType);
    ...
    {
        return $this->unlockCatalogItemAsyncWithHttpInfo($catalogName, $idOrCode, $catalogItem, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->updateCatalogItemWithHttpInfo($catalogName, $idOrCode, $catalogItemUpdate, $contentType);
    }
    ...
    {
        $request = $this->updateCatalogItemRequest($catalogName, $idOrCode, $catalogItemUpdate, $contentType);
    ...
    {
        return $this->updateCatalogItemAsyncWithHttpInfo($catalogName, $idOrCode, $catalogItemUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
