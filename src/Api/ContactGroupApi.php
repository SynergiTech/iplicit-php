...
class ContactGroupApi
{
    ...
    {
        list($response) = $this->getContactGroupWithHttpInfo($contactGroupRef, $domain, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getContactGroupRequest($contactGroupRef, $domain, $include, $contentType);
    ...
    {
        return $this->getContactGroupAsyncWithHttpInfo($contactGroupRef, $domain, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getContactGroup'
            );
        }
