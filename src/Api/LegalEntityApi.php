...
class LegalEntityApi
{
    ...
    {
        list($response) = $this->getAllLegalEntitiesWithHttpInfo($domain, $take, $skip, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getAllLegalEntitiesRequest($domain, $take, $skip, $contentType);
    ...
    {
        return $this->getAllLegalEntitiesAsyncWithHttpInfo($domain, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getAllLegalEntities'
            );
        }
