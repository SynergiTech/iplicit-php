...
class PurchaseInvoiceApi
{
    ...
    {
        list($response) = $this->createPurchaseInvoiceWithHttpInfo($domain, $docCreate, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createPurchaseInvoiceRequest($domain, $docCreate, $contentType);
    ...
    {
        return $this->createPurchaseInvoiceAsyncWithHttpInfo($domain, $docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling createPurchaseInvoice'
            );
        }
    ...
    {
        list($response) = $this->getPurchaseInvoiceWithHttpInfo($id, $domain, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getPurchaseInvoiceRequest($id, $domain, $include, $contentType);
    ...
    {
        return $this->getPurchaseInvoiceAsyncWithHttpInfo($id, $domain, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getPurchaseInvoice'
            );
        }
    ...
    {
        $request = $this->getPurchaseInvoicesRequest($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType);
    ...
    {
        return $this->getPurchaseInvoicesAsyncWithHttpInfo($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getPurchaseInvoices'
            );
        }
    ...
    {
        $this->submitPurchaseInvoiceWithHttpInfo($id, $domain, $contentType);
    }
    ...
    {
        $request = $this->submitPurchaseInvoiceRequest($id, $domain, $contentType);
    ...
    {
        return $this->submitPurchaseInvoiceAsyncWithHttpInfo($id, $domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling submitPurchaseInvoice'
            );
        }
    ...
    {
        $this->updatePurchaseInvoiceWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType);
    }
    ...
    {
        $request = $this->updatePurchaseInvoiceRequest($idOrDocNo, $domain, $docUpdate, $contentType);
    ...
    {
        return $this->updatePurchaseInvoiceAsyncWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling updatePurchaseInvoice'
            );
        }
