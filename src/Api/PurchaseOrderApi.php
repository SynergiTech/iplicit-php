...
class PurchaseOrderApi
{
    ...
    {
        list($response) = $this->createPurchaseOrderWithHttpInfo($domain, $docCreate, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createPurchaseOrderRequest($domain, $docCreate, $contentType);
    ...
    {
        return $this->createPurchaseOrderAsyncWithHttpInfo($domain, $docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling createPurchaseOrder'
            );
        }
    ...
    {
        list($response) = $this->getPurchaseOrderWithHttpInfo($id, $domain, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getPurchaseOrderRequest($id, $domain, $include, $contentType);
    ...
    {
        return $this->getPurchaseOrderAsyncWithHttpInfo($id, $domain, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getPurchaseOrder'
            );
        }
    ...
    {
        return $this->getPurchaseOrdersAsyncWithHttpInfo($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getPurchaseOrders'
            );
        }
    ...
    {
        $this->submitPurchaseOrderWithHttpInfo($id, $domain, $contentType);
    }
    ...
    {
        $request = $this->submitPurchaseOrderRequest($id, $domain, $contentType);
    ...
    {
        return $this->submitPurchaseOrderAsyncWithHttpInfo($id, $domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling submitPurchaseOrder'
            );
        }
    ...
    {
        $this->updatePurchaseOrderWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType);
    }
    ...
    {
        $request = $this->updatePurchaseOrderRequest($idOrDocNo, $domain, $docUpdate, $contentType);
    ...
    {
        return $this->updatePurchaseOrderAsyncWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling updatePurchaseOrder'
            );
        }
