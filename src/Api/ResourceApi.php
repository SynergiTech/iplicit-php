...
class ResourceApi
{
    ...
    ): \SynergiTech\Iplicit\Model\ResourceRead|\SynergiTech\Iplicit\Model\ProblemDetails
    {
        list($response) = $this->getResourceWithHttpInfo($id, $domain, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getResourceRequest($id, $domain, $contentType);
    ...
    {
        return $this->getResourceAsyncWithHttpInfo($id, $domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getResource'
            );
        }
