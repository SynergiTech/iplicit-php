...
class SaleInvoiceApi
{
    ...
    {
        list($response) = $this->createSaleInvoiceWithHttpInfo($docCreate, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createSaleInvoiceRequest($docCreate, $contentType);
    ...
    {
        return $this->createSaleInvoiceAsyncWithHttpInfo($docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getSaleInvoiceWithHttpInfo($id, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getSaleInvoiceRequest($id, $include, $contentType);
    ...
    {
        return $this->getSaleInvoiceAsyncWithHttpInfo($id, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $request = $this->getSaleInvoicesRequest($docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType);
    ...
    {
        return $this->getSaleInvoicesAsyncWithHttpInfo($docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->submitSaleInvoiceWithHttpInfo($id, $contentType);
    }
    ...
    {
        $request = $this->submitSaleInvoiceRequest($id, $contentType);
    ...
    {
        return $this->submitSaleInvoiceAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->updateSaleInvoiceWithHttpInfo($idOrDocNo, $docUpdate, $contentType);
    }
    ...
    {
        $request = $this->updateSaleInvoiceRequest($idOrDocNo, $docUpdate, $contentType);
    ...
    {
        return $this->updateSaleInvoiceAsyncWithHttpInfo($idOrDocNo, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
