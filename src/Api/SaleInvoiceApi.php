...
/**
 * SaleInvoiceApi Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SaleInvoiceApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSaleInvoice'] to see the possible values for this operation
     *
    ...
    public function createSaleInvoice(
        ...
        string $contentType = self::contentTypes['createSaleInvoice'][0]
    ): string
    {
        list($response) = $this->createSaleInvoiceWithHttpInfo($domain, $docCreate, $contentType);
        return $response;
    }

    /**
     * Operation createSaleInvoiceWithHttpInfo
     *
     * Create a sale invoice.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     */
    public function createSaleInvoiceWithHttpInfo(
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocCreate $docCreate = null,
        string $contentType = self::contentTypes['createSaleInvoice'][0]
    ): array
    {
        $request = $this->createSaleInvoiceRequest($domain, $docCreate, $contentType);
    ...
    /**
     * Operation createSaleInvoiceAsync
     *
     * Create a sale invoice.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     */
    public function createSaleInvoiceAsync(
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocCreate $docCreate = null,
        string $contentType = self::contentTypes['createSaleInvoice'][0]
    ): PromiseInterface
    {
        return $this->createSaleInvoiceAsyncWithHttpInfo($domain, $docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createSaleInvoiceAsyncWithHttpInfo
     *
     * Create a sale invoice.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     * @return PromiseInterface
     */
    public function createSaleInvoiceAsyncWithHttpInfo(
        $domain,
        $docCreate = null,
        string $contentType = self::contentTypes['createSaleInvoice'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'createSaleInvoice'
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocCreate|null $docCreate (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSaleInvoice'] to see the possible values for this operation
     ...
     */
    public function createSaleInvoiceRequest(
        $domain,
        $docCreate = null,
        string $contentType = self::contentTypes['createSaleInvoice'][0]
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling createSaleInvoice'
            );
        }



        $resourcePath = '/api/SaleInvoice';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Get a sale invoice
     *
     * @param  string $id Id or documnt number of the sale invoice (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
    ...
    public function getSaleInvoice(
        ...
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleInvoice'][0]
    ): \SynergiTech\Iplicit\Model\Doc
    {
        list($response) = $this->getSaleInvoiceWithHttpInfo($id, $domain, $include, $contentType);
        return $response;
    }
     ...
     */
    public function getSaleInvoiceWithHttpInfo(
        string $id,
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleInvoice'][0]
    ...
    {
        $request = $this->getSaleInvoiceRequest($id, $domain, $include, $contentType);
     ...
     * @return PromiseInterface
     */
    public function getSaleInvoiceAsync(
        string $id,
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleInvoice'][0]
    ...
    {
        return $this->getSaleInvoiceAsyncWithHttpInfo($id, $domain, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function getSaleInvoiceAsyncWithHttpInfo(
        $id,
        $domain,
        $include = null,
        string $contentType = self::contentTypes['getSaleInvoice'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleInvoiceRequest(
        $id,
        $domain,
        $include = null,
        string $contentType = self::contentTypes['getSaleInvoice'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling getSaleInvoice'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getSaleInvoice'
            );
        }



        $resourcePath = '/api/SaleInvoice/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSaleInvoices'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function getSaleInvoicesWithHttpInfo(
        string $domain,
        ?string $docNo = null,
        ?string $docType = null,
        ?string $docTypeId = null,
    ...
    {
        $request = $this->getSaleInvoicesRequest($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType);
    ...
    /**
     * Operation getSaleInvoicesAsync
     *
     * Get a list of sale invoices with a search filter
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     * @return PromiseInterface
     */
    public function getSaleInvoicesAsync(
        string $domain,
        ?string $docNo = null,
        ?string $docType = null,
        ?string $docTypeId = null,
    ...
    {
        return $this->getSaleInvoicesAsyncWithHttpInfo($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSaleInvoicesAsyncWithHttpInfo
     *
     * Get a list of sale invoices with a search filter
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     * @return PromiseInterface
     */
    public function getSaleInvoicesAsyncWithHttpInfo(
        $domain,
        $docNo = null,
        $docType = null,
        $docTypeId = null,
    ...
    /**
     * Create request for operation 'getSaleInvoices'
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string|null $docNo The document number (optional)
     * @param  string|null $docType The document type code (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleInvoicesRequest(
        $domain,
        $docNo = null,
        $docType = null,
        $docTypeId = null,
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getSaleInvoices'
            );
        }
    ...
    /**
     * Operation submitSaleInvoice
     *
     * Submit a sale invoice for authorisation and posting.
     *
     * @param  string $id Id of the sale invoice (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitSaleInvoice'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function submitSaleInvoice(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleInvoice'][0]
    ): void
    {
        $this->submitSaleInvoiceWithHttpInfo($id, $domain, $contentType);
    }

    /**
     * Operation submitSaleInvoiceWithHttpInfo
     *
     * Submit a sale invoice for authorisation and posting.
     *
     * @param  string $id Id of the sale invoice (required)
     ...
     */
    public function submitSaleInvoiceWithHttpInfo(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleInvoice'][0]
    ): array
    {
        $request = $this->submitSaleInvoiceRequest($id, $domain, $contentType);
    ...
    /**
     * Operation submitSaleInvoiceAsync
     *
     * Submit a sale invoice for authorisation and posting.
     *
     * @param  string $id Id of the sale invoice (required)
     ...
     * @return PromiseInterface
     */
    public function submitSaleInvoiceAsync(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleInvoice'][0]
    ): PromiseInterface
    {
        return $this->submitSaleInvoiceAsyncWithHttpInfo($id, $domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitSaleInvoiceAsyncWithHttpInfo
     *
     * Submit a sale invoice for authorisation and posting.
     *
     * @param  string $id Id of the sale invoice (required)
     ...
     * @return PromiseInterface
     */
    public function submitSaleInvoiceAsyncWithHttpInfo(
        $id,
        $domain,
        string $contentType = self::contentTypes['submitSaleInvoice'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'submitSaleInvoice'
     *
     * @param  string $id Id of the sale invoice (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitSaleInvoice'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function submitSaleInvoiceRequest(
        $id,
        $domain,
        string $contentType = self::contentTypes['submitSaleInvoice'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling submitSaleInvoice'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling submitSaleInvoice'
            );
        }


        $resourcePath = '/api/SaleInvoice/{id}/submit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation updateSaleInvoice
     *
     * Update a sale invoice
     *
     * @param  string $idOrDocNo Id or documnt number of the sale invoice (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocUpdate|null $docUpdate docUpdate (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSaleInvoice'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
    ...
    public function updateSaleInvoice(
        ...
        string $contentType = self::contentTypes['updateSaleInvoice'][0]
    ): void
    {
        $this->updateSaleInvoiceWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType);
    }

    /**
     * Operation updateSaleInvoiceWithHttpInfo
     *
     * Update a sale invoice
     *
     * @param  string $idOrDocNo Id or documnt number of the sale invoice (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSaleInvoiceWithHttpInfo(
        string $idOrDocNo,
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocUpdate $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleInvoice'][0]
    ...
    {
        $request = $this->updateSaleInvoiceRequest($idOrDocNo, $domain, $docUpdate, $contentType);
    ...
    /**
     * Operation updateSaleInvoiceAsync
     *
     * Update a sale invoice
     *
     * @param  string $idOrDocNo Id or documnt number of the sale invoice (required)
     ...
     * @return PromiseInterface
     */
    public function updateSaleInvoiceAsync(
        string $idOrDocNo,
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocUpdate $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleInvoice'][0]
    ...
    {
        return $this->updateSaleInvoiceAsyncWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateSaleInvoiceAsyncWithHttpInfo
     *
     * Update a sale invoice
     *
     * @param  string $idOrDocNo Id or documnt number of the sale invoice (required)
     ...
     * @return PromiseInterface
     */
    public function updateSaleInvoiceAsyncWithHttpInfo(
        $idOrDocNo,
        $domain,
        $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleInvoice'][0]
    ...
    /**
     * Create request for operation 'updateSaleInvoice'
     *
     * @param  string $idOrDocNo Id or documnt number of the sale invoice (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocUpdate|null $docUpdate (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSaleInvoiceRequest(
        $idOrDocNo,
        $domain,
        $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleInvoice'][0]
    ): Request
    {
        ...
        if ($idOrDocNo === null || (is_array($idOrDocNo) && count($idOrDocNo) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $idOrDocNo when calling updateSaleInvoice'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling updateSaleInvoice'
            );
        }



        $resourcePath = '/api/SaleInvoice/{idOrDocNo}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
