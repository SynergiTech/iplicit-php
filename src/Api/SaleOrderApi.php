...
/**
 * SaleOrderApi Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SaleOrderApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSaleOrder'] to see the possible values for this operation
     *
    ...
    public function createSaleOrder(
        ...
        string $contentType = self::contentTypes['createSaleOrder'][0]
    ): string
    {
        list($response) = $this->createSaleOrderWithHttpInfo($domain, $docCreate, $contentType);
        return $response;
    }

    /**
     * Operation createSaleOrderWithHttpInfo
     *
     * Create a sale order.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     */
    public function createSaleOrderWithHttpInfo(
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocCreate $docCreate = null,
        string $contentType = self::contentTypes['createSaleOrder'][0]
    ): array
    {
        $request = $this->createSaleOrderRequest($domain, $docCreate, $contentType);
    ...
    /**
     * Operation createSaleOrderAsync
     *
     * Create a sale order.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     */
    public function createSaleOrderAsync(
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocCreate $docCreate = null,
        string $contentType = self::contentTypes['createSaleOrder'][0]
    ): PromiseInterface
    {
        return $this->createSaleOrderAsyncWithHttpInfo($domain, $docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createSaleOrderAsyncWithHttpInfo
     *
     * Create a sale order.
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     * @return PromiseInterface
     */
    public function createSaleOrderAsyncWithHttpInfo(
        $domain,
        $docCreate = null,
        string $contentType = self::contentTypes['createSaleOrder'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'createSaleOrder'
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocCreate|null $docCreate (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSaleOrder'] to see the possible values for this operation
     ...
     */
    public function createSaleOrderRequest(
        $domain,
        $docCreate = null,
        string $contentType = self::contentTypes['createSaleOrder'][0]
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling createSaleOrder'
            );
        }



        $resourcePath = '/api/SaleOrder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Get a sale order
     *
     * @param  string $id Id or document number of the sale order (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
    ...
    public function getSaleOrder(
        ...
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleOrder'][0]
    ): \SynergiTech\Iplicit\Model\Doc
    {
        list($response) = $this->getSaleOrderWithHttpInfo($id, $domain, $include, $contentType);
        return $response;
    }
     ...
     */
    public function getSaleOrderWithHttpInfo(
        string $id,
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleOrder'][0]
    ...
    {
        $request = $this->getSaleOrderRequest($id, $domain, $include, $contentType);
     ...
     * @return PromiseInterface
     */
    public function getSaleOrderAsync(
        string $id,
        string $domain,
        ?string $include = null,
        string $contentType = self::contentTypes['getSaleOrder'][0]
    ...
    {
        return $this->getSaleOrderAsyncWithHttpInfo($id, $domain, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function getSaleOrderAsyncWithHttpInfo(
        $id,
        $domain,
        $include = null,
        string $contentType = self::contentTypes['getSaleOrder'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleOrderRequest(
        $id,
        $domain,
        $include = null,
        string $contentType = self::contentTypes['getSaleOrder'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling getSaleOrder'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getSaleOrder'
            );
        }



        $resourcePath = '/api/SaleOrder/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSaleOrders'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function getSaleOrdersWithHttpInfo(
        string $domain,
        ?string $docNo = null,
        ?string $docType = null,
        ?string $docTypeId = null,
     ...
     * @return PromiseInterface
     */
    public function getSaleOrdersAsync(
        string $domain,
        ?string $docNo = null,
        ?string $docType = null,
        ?string $docTypeId = null,
    ...
    {
        return $this->getSaleOrdersAsyncWithHttpInfo($domain, $docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSaleOrdersAsyncWithHttpInfo
     *
     * Get sale orders with a search filter
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     ...
     * @return PromiseInterface
     */
    public function getSaleOrdersAsyncWithHttpInfo(
        $domain,
        $docNo = null,
        $docType = null,
        $docTypeId = null,
    ...
    /**
     * Create request for operation 'getSaleOrders'
     *
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string|null $docNo The document number (optional)
     * @param  string|null $docType The document type code (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSaleOrdersRequest(
        $domain,
        $docNo = null,
        $docType = null,
        $docTypeId = null,
    ...
    ): Request
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling getSaleOrders'
            );
        }
    ...
    /**
     * Operation submitSaleOrder
     *
     * Submit a sale order for authorisation.
     *
     * @param  string $id Id of the sale order (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitSaleOrder'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function submitSaleOrder(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleOrder'][0]
    ): void
    {
        $this->submitSaleOrderWithHttpInfo($id, $domain, $contentType);
    }

    /**
     * Operation submitSaleOrderWithHttpInfo
     *
     * Submit a sale order for authorisation.
     *
     * @param  string $id Id of the sale order (required)
     ...
     */
    public function submitSaleOrderWithHttpInfo(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleOrder'][0]
    ): array
    {
        $request = $this->submitSaleOrderRequest($id, $domain, $contentType);
    ...
    /**
     * Operation submitSaleOrderAsync
     *
     * Submit a sale order for authorisation.
     *
     * @param  string $id Id of the sale order (required)
     ...
     * @return PromiseInterface
     */
    public function submitSaleOrderAsync(
        string $id,
        string $domain,
        string $contentType = self::contentTypes['submitSaleOrder'][0]
    ): PromiseInterface
    {
        return $this->submitSaleOrderAsyncWithHttpInfo($id, $domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitSaleOrderAsyncWithHttpInfo
     *
     * Submit a sale order for authorisation.
     *
     * @param  string $id Id of the sale order (required)
     ...
     * @return PromiseInterface
     */
    public function submitSaleOrderAsyncWithHttpInfo(
        $id,
        $domain,
        string $contentType = self::contentTypes['submitSaleOrder'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'submitSaleOrder'
     *
     * @param  string $id Id of the sale order (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitSaleOrder'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function submitSaleOrderRequest(
        $id,
        $domain,
        string $contentType = self::contentTypes['submitSaleOrder'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling submitSaleOrder'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling submitSaleOrder'
            );
        }


        $resourcePath = '/api/SaleOrder/{id}/submit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Update a sale order
     *
     * @param  string $idOrDocNo Id or document number of the sale order (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocUpdate|null $docUpdate docUpdate (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSaleOrder'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
    ...
    public function updateSaleOrder(
        ...
        string $contentType = self::contentTypes['updateSaleOrder'][0]
    ): void
    {
        $this->updateSaleOrderWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType);
    }

    /**
     * Operation updateSaleOrderWithHttpInfo
     *
     * Update a sale order
     *
     * @param  string $idOrDocNo Id or document number of the sale order (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSaleOrderWithHttpInfo(
        string $idOrDocNo,
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocUpdate $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleOrder'][0]
    ...
    {
        $request = $this->updateSaleOrderRequest($idOrDocNo, $domain, $docUpdate, $contentType);
    ...
    /**
     * Operation updateSaleOrderAsync
     *
     * Update a sale order
     *
     * @param  string $idOrDocNo Id or document number of the sale order (required)
     ...
     * @return PromiseInterface
     */
    public function updateSaleOrderAsync(
        string $idOrDocNo,
        string $domain,
        ?\SynergiTech\Iplicit\Model\DocUpdate $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleOrder'][0]
    ...
    {
        return $this->updateSaleOrderAsyncWithHttpInfo($idOrDocNo, $domain, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateSaleOrderAsyncWithHttpInfo
     *
     * Update a sale order
     *
     * @param  string $idOrDocNo Id or document number of the sale order (required)
     ...
     * @return PromiseInterface
     */
    public function updateSaleOrderAsyncWithHttpInfo(
        $idOrDocNo,
        $domain,
        $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleOrder'][0]
    ...
    /**
     * Create request for operation 'updateSaleOrder'
     *
     * @param  string $idOrDocNo Id or document number of the sale order (required)
     * @param  string $domain Your assigned domain name. Required for all API requests. (required)
     * @param  \SynergiTech\Iplicit\Model\DocUpdate|null $docUpdate (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSaleOrderRequest(
        $idOrDocNo,
        $domain,
        $docUpdate = null,
        string $contentType = self::contentTypes['updateSaleOrder'][0]
    ): Request
    {
        ...
        if ($idOrDocNo === null || (is_array($idOrDocNo) && count($idOrDocNo) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $idOrDocNo when calling updateSaleOrder'
            );
        }
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $domain when calling updateSaleOrder'
            );
        }



        $resourcePath = '/api/SaleOrder/{idOrDocNo}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
