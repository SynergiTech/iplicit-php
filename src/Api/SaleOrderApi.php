...
class SaleOrderApi
{
    ...
    {
        list($response) = $this->createSaleOrderWithHttpInfo($docCreate, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createSaleOrderRequest($docCreate, $contentType);
    ...
    {
        return $this->createSaleOrderAsyncWithHttpInfo($docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getSaleOrderWithHttpInfo($id, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getSaleOrderRequest($id, $include, $contentType);
    ...
    {
        return $this->getSaleOrderAsyncWithHttpInfo($id, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->submitSaleOrderWithHttpInfo($id, $contentType);
    }
    ...
    {
        $request = $this->submitSaleOrderRequest($id, $contentType);
    ...
    {
        return $this->submitSaleOrderAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->updateSaleOrderWithHttpInfo($idOrDocNo, $docUpdate, $contentType);
    }
    ...
    {
        $request = $this->updateSaleOrderRequest($idOrDocNo, $docUpdate, $contentType);
    ...
    {
        return $this->updateSaleOrderAsyncWithHttpInfo($idOrDocNo, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
