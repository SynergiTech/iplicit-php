...
class SaleQuoteApi
{
    ...
    {
        list($response) = $this->createSaleQuoteWithHttpInfo($docCreate, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createSaleQuoteRequest($docCreate, $contentType);
    ...
    {
        return $this->createSaleQuoteAsyncWithHttpInfo($docCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getSaleQuoteWithHttpInfo($id, $include, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getSaleQuoteRequest($id, $include, $contentType);
    ...
    {
        return $this->getSaleQuoteAsyncWithHttpInfo($id, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $request = $this->getSaleQuotesRequest($docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType);
    ...
    {
        return $this->getSaleQuotesAsyncWithHttpInfo($docNo, $docType, $docTypeId, $contactAccount, $contactAccountId, $legalEntity, $legalEntityId, $currency, $project, $projectId, $description, $descriptionContains, $theirRef, $intRef, $legacyRef, $theirDocNo, $docClass, $docDateFrom, $docDateTo, $dueDateFrom, $dueDateTo, $lastModifiedFrom, $lastModifiedTo, $outstanding, $unmatched, $draft, $abandoned, $posted, $approved, $reversed, $take, $skip, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->submitSaleQuoteWithHttpInfo($id, $contentType);
    }
    ...
    {
        $request = $this->submitSaleQuoteRequest($id, $contentType);
    ...
    {
        return $this->submitSaleQuoteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->updateSaleQuoteWithHttpInfo($idOrDocNo, $docUpdate, $contentType);
    }
    ...
    {
        $request = $this->updateSaleQuoteRequest($idOrDocNo, $docUpdate, $contentType);
    ...
    {
        return $this->updateSaleQuoteAsyncWithHttpInfo($idOrDocNo, $docUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
