...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.iplicit.com';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/1.13.0/PHP';
    ...
    public function setDomainHeader(string $domainHeader): static
    {
     ...
     * @return string Access token for OAuth
     */
    public function getDomainHeader(): string
    {
        return $this->domainHeader;
    }
    ...
    {
        $report  = 'PHP SDK (SynergiTech\Iplicit) Debug Report:' . PHP_EOL;
