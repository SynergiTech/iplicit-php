...
class AttachmentRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttachmentRead';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The attachment unique id
     *
     * @return $this
     */
    ...
    public function setDocumentDate(?\DateTime $documentDate): static
    {
        if (is_null($documentDate)) {
            throw new InvalidArgumentException('non-nullable documentDate cannot be null');
        }
     ...
     * Sets fileName
     *
     * @param string|null $fileName The attachment file name
     *
     * @return $this
     */
     ...
     * Sets fileSize
     *
     * @param int|null $fileSize The attachment file size
     *
     * @return $this
     */
