...
/**
 * BankTransactionCreate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BankTransactionCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BankTransactionCreate';
    ...
    protected static array $setters = [
        'bankAccountRef' => 'setBankAccountRef',
    ...
    protected static array $getters = [
        'bankAccountRef' => 'getBankAccountRef',
    ...
    {
        $this->setIfExists('bankAccountRef', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['bankAccountRef'] === null) {
            $invalidProperties[] = "'bankAccountRef' can't be null";
        }
        if ((mb_strlen($this->container['bankAccountRef']) < 1)) {
            $invalidProperties[] = "invalid value for 'bankAccountRef', the character length must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['bankDate'] === null) {
            $invalidProperties[] = "'bankDate' can't be null";
        }
     ...
     * @return string
     */
    public function getBankAccountRef(): string
    {
        return $this->container['bankAccountRef'];
    }

    /**
     * Sets bankAccountRef
     *
     * @param string $bankAccountRef The bank transaction bank acccount reference
     *
     * @return $this
     */
    public function setBankAccountRef(string $bankAccountRef): static
    {
        if (is_null($bankAccountRef)) {
            throw new InvalidArgumentException('non-nullable bankAccountRef cannot be null');
        }

        if ((mb_strlen($bankAccountRef) < 1)) {
            throw new InvalidArgumentException('invalid length for $bankAccountRef when calling BankTransactionCreate., must be bigger than or equal to 1.');
        }

        $this->container['bankAccountRef'] = $bankAccountRef;
     ...
     * Sets description
     *
     * @param string $description The bank transaction description
     *
     * @return $this
     */
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 250)) {
            throw new InvalidArgumentException('invalid length for $description when calling BankTransactionCreate., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling BankTransactionCreate., must be bigger than or equal to 1.');
        }
     ...
     * Sets bankDate
     *
     * @param \DateTime $bankDate The bank transaction bank date
     *
     * @return $this
     */
    ...
    public function setBankReference(?string $bankReference): static
    {
        ...
        if (!is_null($bankReference) && (mb_strlen($bankReference) > 50)) {
            throw new InvalidArgumentException('invalid length for $bankReference when calling BankTransactionCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setMerchantName(?string $merchantName): static
    {
        ...
        if (!is_null($merchantName) && (mb_strlen($merchantName) > 100)) {
            throw new InvalidArgumentException('invalid length for $merchantName when calling BankTransactionCreate., must be smaller than or equal to 100.');
        }
