...
/**
 * BatchPaymentUpdate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BatchPaymentUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BatchPaymentUpdate';
    ...
    */
     ...
     * @return float|null
     */
    public function getPaymentDate(): ?float
    {
     ...
     * Sets paymentDate
     *
     * @param float|null $paymentDate The batch payment date
     *
     * @return $this
     */
    public function setPaymentDate(?float $paymentDate): static
    {
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new InvalidArgumentException('invalid length for $description when calling BatchPaymentUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setBankRef(?string $bankRef): static
    {
        ...
        if (!is_null($bankRef) && (mb_strlen($bankRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $bankRef when calling BatchPaymentUpdate., must be smaller than or equal to 50.');
        }
