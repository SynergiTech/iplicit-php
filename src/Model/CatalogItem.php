...
class CatalogItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CatalogItem';
    ...
    */
     ...
     * Sets isActive
     *
     * @param bool|null $isActive Active or locked (soft delete), not supported by all catalogs and may be omitted
     *
     * @return $this
     */
