...
/**
 * ContactAddressInline Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactAddressInline implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactAddressInline';
    ...
    */
    ...
    public function setType(?string $type): static
    {
        ...
        if (!is_null($type) && (mb_strlen($type) > 50)) {
            throw new InvalidArgumentException('invalid length for $type when calling ContactAddressInline., must be smaller than or equal to 50.');
        }
    ...
    public function setAddress(string $address): static
    {
        ...
        if ((mb_strlen($address) > 250)) {
            throw new InvalidArgumentException('invalid length for $address when calling ContactAddressInline., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($address) < 1)) {
            throw new InvalidArgumentException('invalid length for $address when calling ContactAddressInline., must be bigger than or equal to 1.');
        }
    ...
    public function setPostCode(string $postCode): static
    {
        ...
        if ((mb_strlen($postCode) > 50)) {
            throw new InvalidArgumentException('invalid length for $postCode when calling ContactAddressInline., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($postCode) < 1)) {
            throw new InvalidArgumentException('invalid length for $postCode when calling ContactAddressInline., must be bigger than or equal to 1.');
        }
    ...
    public function setCity(?string $city): static
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new InvalidArgumentException('invalid length for $city when calling ContactAddressInline., must be smaller than or equal to 50.');
        }
    ...
    public function setCounty(?string $county): static
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 50)) {
            throw new InvalidArgumentException('invalid length for $county when calling ContactAddressInline., must be smaller than or equal to 50.');
        }
    ...
    public function setCountryCode(?string $countryCode): static
    {
        ...
        if (!is_null($countryCode) && (mb_strlen($countryCode) > 2)) {
            throw new InvalidArgumentException('invalid length for $countryCode when calling ContactAddressInline., must be smaller than or equal to 2.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ContactAddressInline., must be smaller than or equal to 100.');
        }
