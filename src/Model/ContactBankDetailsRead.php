...
/**
 * ContactBankDetailsRead Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactBankDetailsRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactBankDetailsRead';
    ...
    */
    ...
    public function setIban(?string $iban): static
    {
        ...
        if (!is_null($iban) && (mb_strlen($iban) > 50)) {
            throw new InvalidArgumentException('invalid length for $iban when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
    ...
    public function setAccountNo(?string $accountNo): static
    {
        ...
        if (!is_null($accountNo) && (mb_strlen($accountNo) > 30)) {
            throw new InvalidArgumentException('invalid length for $accountNo when calling ContactBankDetailsRead., must be smaller than or equal to 30.');
        }
    ...
    public function setSortCode(?string $sortCode): static
    {
        ...
        if (!is_null($sortCode) && (mb_strlen($sortCode) > 8)) {
            throw new InvalidArgumentException('invalid length for $sortCode when calling ContactBankDetailsRead., must be smaller than or equal to 8.');
        }
    ...
    public function setBic(?string $bic): static
    {
        ...
        if (!is_null($bic) && (mb_strlen($bic) > 50)) {
            throw new InvalidArgumentException('invalid length for $bic when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
    ...
    public function setRoutingCode(?string $routingCode): static
    {
        ...
        if (!is_null($routingCode) && (mb_strlen($routingCode) > 20)) {
            throw new InvalidArgumentException('invalid length for $routingCode when calling ContactBankDetailsRead., must be smaller than or equal to 20.');
        }
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ContactBankDetailsRead., must be smaller than or equal to 3.');
        }
    ...
    public function setLegacyRef(?string $legacyRef): static
    {
        ...
        if (!is_null($legacyRef) && (mb_strlen($legacyRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $legacyRef when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
    ...
    public function setBankId(?string $bankId): static
    {
        ...
        if (!is_null($bankId) && (mb_strlen($bankId) > 50)) {
            throw new InvalidArgumentException('invalid length for $bankId when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
    ...
    public function setBankRef(?string $bankRef): static
    {
        ...
        if (!is_null($bankRef) && (mb_strlen($bankRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $bankRef when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
    ...
    public function setCountryCode(?string $countryCode): static
    {
        ...
        if (!is_null($countryCode) && (mb_strlen($countryCode) > 2)) {
            throw new InvalidArgumentException('invalid length for $countryCode when calling ContactBankDetailsRead., must be smaller than or equal to 2.');
        }
    ...
    public function setBankAddress(?string $bankAddress): static
    {
        ...
        if (!is_null($bankAddress) && (mb_strlen($bankAddress) > 100)) {
            throw new InvalidArgumentException('invalid length for $bankAddress when calling ContactBankDetailsRead., must be smaller than or equal to 100.');
        }
    ...
    public function setAccountName(?string $accountName): static
    {
        ...
        if (!is_null($accountName) && (mb_strlen($accountName) > 50)) {
            throw new InvalidArgumentException('invalid length for $accountName when calling ContactBankDetailsRead., must be smaller than or equal to 50.');
        }
