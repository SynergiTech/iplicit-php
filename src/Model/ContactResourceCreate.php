...
/**
 * ContactResourceCreate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactResourceCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactResourceCreate';
    ...
    protected static array $openAPITypes = [
        ...
        'sendRemittance' => 'bool',
        'resourceEmployments' => '\SynergiTech\Iplicit\Model\ResourceEmploymentCreate[]',
        'resourceUmbrellas' => '\SynergiTech\Iplicit\Model\ResourceUmbrellaCreate[]',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['resourceGroupId'] === null) {
            $invalidProperties[] = "'resourceGroupId' can't be null";
        }
        if ((mb_strlen($this->container['resourceGroupId']) < 1)) {
     ...
     *
     * @param string $resourceGroupId Required, the *Resource group* will determine defaults for all the other unspecified resource fields. See `ResourceGroup` catalog.
     *
     * @return $this
     */
    public function setResourceGroupId(string $resourceGroupId): static
    {
        if (is_null($resourceGroupId)) {
            throw new InvalidArgumentException('non-nullable resourceGroupId cannot be null');
        }

        if ((mb_strlen($resourceGroupId) < 1)) {
            throw new InvalidArgumentException('invalid length for $resourceGroupId when calling ContactResourceCreate., must be bigger than or equal to 1.');
        }
    ...
    public function setNationalInsuranceNo(?string $nationalInsuranceNo): static
    {
        ...
        if (!is_null($nationalInsuranceNo) && (mb_strlen($nationalInsuranceNo) > 50)) {
            throw new InvalidArgumentException('invalid length for $nationalInsuranceNo when calling ContactResourceCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ContactResourceCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setUniqueTaxpayerReference(?string $uniqueTaxpayerReference): static
    {
        ...
        if (!is_null($uniqueTaxpayerReference) && (mb_strlen($uniqueTaxpayerReference) > 50)) {
            throw new InvalidArgumentException('invalid length for $uniqueTaxpayerReference when calling ContactResourceCreate., must be smaller than or equal to 50.');
        }
     ...
     *
     * @return \SynergiTech\Iplicit\Model\ResourceEmploymentCreate[]|null
     */
     ...
     *
     * @param \SynergiTech\Iplicit\Model\ResourceEmploymentCreate[]|null $resourceEmployments List of resource employment records
     *
     * @return $this
     */
     ...
     *
     * @return \SynergiTech\Iplicit\Model\ResourceUmbrellaCreate[]|null
     */
     ...
     *
     * @param \SynergiTech\Iplicit\Model\ResourceUmbrellaCreate[]|null $resourceUmbrellas List of resource umbrella supplier records
     *
     * @return $this
     */
