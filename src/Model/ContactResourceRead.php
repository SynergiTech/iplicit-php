...
/**
 * ContactResourceRead Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactResourceRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactResourceRead';
    ...
    protected static array $openAPITypes = [
        ...
        'sendRemittance' => 'bool',
        'timesheetProducts' => '\SynergiTech\Iplicit\Model\TimesheetProductRead[]',
        'expenseProducts' => '\SynergiTech\Iplicit\Model\ExpenseProductRead[]',
        'resourceEmployments' => '\SynergiTech\Iplicit\Model\ResourceEmploymentRead[]',
        'resourceUmbrellas' => '\SynergiTech\Iplicit\Model\ResourceUmbrellaRead[]',
    ...
    protected static array $openAPIFormats = [
        ...
        'paymentTermsId' => 'uuid',
        'sendRemittance' => null,
        'timesheetProducts' => null,
        'expenseProducts' => null,
        'resourceEmployments' => null,
        'resourceUmbrellas' => null,
        'ext' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'timesheetProducts' => true,
        'expenseProducts' => true,
        'resourceEmployments' => true,
        'resourceUmbrellas' => true,
        'ext' => true
    ];
    ...
    protected static array $attributeMap = [
        ...
        'timesheetProducts' => 'timesheetProducts',
        'expenseProducts' => 'expenseProducts',
        'resourceEmployments' => 'resourceEmployments',
        'resourceUmbrellas' => 'resourceUmbrellas',
        'ext' => 'ext'
    ];
    ...
    protected static array $setters = [
        ...
        'timesheetProducts' => 'setTimesheetProducts',
        'expenseProducts' => 'setExpenseProducts',
        'resourceEmployments' => 'setResourceEmployments',
        'resourceUmbrellas' => 'setResourceUmbrellas',
        'ext' => 'setExt'
    ];
    ...
    protected static array $getters = [
        ...
        'timesheetProducts' => 'getTimesheetProducts',
        'expenseProducts' => 'getExpenseProducts',
        'resourceEmployments' => 'getResourceEmployments',
        'resourceUmbrellas' => 'getResourceUmbrellas',
        'ext' => 'getExt'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('timesheetProducts', $data ?? [], null);
        $this->setIfExists('expenseProducts', $data ?? [], null);
        $this->setIfExists('resourceEmployments', $data ?? [], null);
        $this->setIfExists('resourceUmbrellas', $data ?? [], null);
    ...
    */
     ...
     * Sets departmentId
     *
     * @param string|null $departmentId Resource department id
     *
     * @return $this
     */
     ...
     * Sets locationId
     *
     * @param string|null $locationId Resource location id
     *
     * @return $this
     */
    ...
    public function setNationalInsuranceNo(?string $nationalInsuranceNo): static
    {
        ...
        if (!is_null($nationalInsuranceNo) && (mb_strlen($nationalInsuranceNo) > 50)) {
            throw new InvalidArgumentException('invalid length for $nationalInsuranceNo when calling ContactResourceRead., must be smaller than or equal to 50.');
        }
     ...
     * Sets absenceGroupId
     *
     * @param string|null $absenceGroupId Resource absence group id
     *
     * @return $this
     */
     ...
     * Sets costCentreId
     *
     * @param string|null $costCentreId Resource cost centre id
     *
     * @return $this
     */
     ...
     *
     * @param string|null $managerResourceId Resource manager id
     *
     * @return $this
     */
    ...
    public function setUniqueTaxpayerReference(?string $uniqueTaxpayerReference): static
    {
        ...
        if (!is_null($uniqueTaxpayerReference) && (mb_strlen($uniqueTaxpayerReference) > 50)) {
            throw new InvalidArgumentException('invalid length for $uniqueTaxpayerReference when calling ContactResourceRead., must be smaller than or equal to 50.');
        }
    ...
    public function setIsSalesperson(?bool $isSalesperson): static
    {
        if (is_null($isSalesperson)) {
            throw new InvalidArgumentException('non-nullable isSalesperson cannot be null');
        }
    ...
    public function setIsRequestor(?bool $isRequestor): static
    {
        if (is_null($isRequestor)) {
            throw new InvalidArgumentException('non-nullable isRequestor cannot be null');
        }
    ...
    public function setAllowExpense(?bool $allowExpense): static
    {
        if (is_null($allowExpense)) {
            throw new InvalidArgumentException('non-nullable allowExpense cannot be null');
        }
    ...
    public function setAllowTask(?bool $allowTask): static
    {
        if (is_null($allowTask)) {
            throw new InvalidArgumentException('non-nullable allowTask cannot be null');
        }
    ...
    public function setAllowTimesheet(?bool $allowTimesheet): static
    {
        if (is_null($allowTimesheet)) {
            throw new InvalidArgumentException('non-nullable allowTimesheet cannot be null');
        }
    ...
    public function setHasEmployment(?bool $hasEmployment): static
    {
        if (is_null($hasEmployment)) {
            throw new InvalidArgumentException('non-nullable hasEmployment cannot be null');
        }
    ...
    public function setHasUmbrella(?bool $hasUmbrella): static
    {
        if (is_null($hasUmbrella)) {
            throw new InvalidArgumentException('non-nullable hasUmbrella cannot be null');
        }
     ...
     *
     * @param string|null $paymentMethodId Expense payment method id
     *
     * @return $this
     */
     ...
     * Sets paymentTermsId
     *
     * @param string|null $paymentTermsId Expense payment terms id
     *
     * @return $this
     */
    ...
    /**
     * Gets timesheetProducts
     *
     * @return \SynergiTech\Iplicit\Model\TimesheetProductRead[]|null
     */
    public function getTimesheetProducts(): ?array
    {
        return $this->container['timesheetProducts'];
    }

    /**
     * Sets timesheetProducts
     *
     * @param \SynergiTech\Iplicit\Model\TimesheetProductRead[]|null $timesheetProducts List of resource timesheet products
     *
     * @return $this
     */
    public function setTimesheetProducts(?array $timesheetProducts): static
    {
        if (is_null($timesheetProducts)) {
            array_push($this->openAPINullablesSetToNull, 'timesheetProducts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('timesheetProducts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['timesheetProducts'] = $timesheetProducts;

        return $this;
    }

    /**
     * Gets expenseProducts
     *
     * @return \SynergiTech\Iplicit\Model\ExpenseProductRead[]|null
     */
    public function getExpenseProducts(): ?array
    {
        return $this->container['expenseProducts'];
    }

    /**
     * Sets expenseProducts
     *
     * @param \SynergiTech\Iplicit\Model\ExpenseProductRead[]|null $expenseProducts List of resource expense products
     *
     * @return $this
     */
    public function setExpenseProducts(?array $expenseProducts): static
    {
        if (is_null($expenseProducts)) {
            array_push($this->openAPINullablesSetToNull, 'expenseProducts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expenseProducts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['expenseProducts'] = $expenseProducts;

        return $this;
    }

    /**
     * Gets resourceEmployments
     *
     * @return \SynergiTech\Iplicit\Model\ResourceEmploymentRead[]|null
     */
    public function getResourceEmployments(): ?array
    {
        return $this->container['resourceEmployments'];
    }

    /**
     * Sets resourceEmployments
     *
     * @param \SynergiTech\Iplicit\Model\ResourceEmploymentRead[]|null $resourceEmployments List of resource employment records
     *
     * @return $this
     */
    public function setResourceEmployments(?array $resourceEmployments): static
    {
        if (is_null($resourceEmployments)) {
            array_push($this->openAPINullablesSetToNull, 'resourceEmployments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resourceEmployments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['resourceEmployments'] = $resourceEmployments;

        return $this;
    }

    /**
     * Gets resourceUmbrellas
     *
     * @return \SynergiTech\Iplicit\Model\ResourceUmbrellaRead[]|null
     */
    public function getResourceUmbrellas(): ?array
    {
        return $this->container['resourceUmbrellas'];
    }

    /**
     * Sets resourceUmbrellas
     *
     * @param \SynergiTech\Iplicit\Model\ResourceUmbrellaRead[]|null $resourceUmbrellas List of resource umbrella supplier records
     *
     * @return $this
     */
    public function setResourceUmbrellas(?array $resourceUmbrellas): static
    {
        if (is_null($resourceUmbrellas)) {
            array_push($this->openAPINullablesSetToNull, 'resourceUmbrellas');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resourceUmbrellas', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['resourceUmbrellas'] = $resourceUmbrellas;
