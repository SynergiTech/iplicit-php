...
class ContactSupplierCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPIFormats = [
        ...
        'paymentRecipientContactAccountId' => null,
        'payTermId' => null,
    ...
    */
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ContactSupplierCreate., must be smaller than or equal to 5.');
        }
