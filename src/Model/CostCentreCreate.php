...
/**
 * CostCentreCreate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CostCentreCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CostCentreCreate';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Unique code for the cost centre
     *
     * @return $this
     */
    public function setCode(string $code): static
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new InvalidArgumentException('invalid length for $code when calling CostCentreCreate., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new InvalidArgumentException('invalid length for $code when calling CostCentreCreate., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string $description Description of the cost centre
     *
     * @return $this
     */
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling CostCentreCreate., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling CostCentreCreate., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $parentCostCentreId The cost centre parent (where specified) can be useful for analytics. Accepts id or code.
     *
     * @return $this
     */
     ...
     * Sets legalEntityId
     *
     * @param string|null $legalEntityId When supplied, the use of the cost centre can be restricted to the specified Legal Entity. Accepts id or code.
     *
     * @return $this
     */
     ...
     * Sets legacyRef
     *
     * @param string|null $legacyRef Legacy reference of the cost centre
     *
     * @return $this
     */
    public function setLegacyRef(?string $legacyRef): static
    {
        ...
        if (!is_null($legacyRef) && (mb_strlen($legacyRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $legacyRef when calling CostCentreCreate., must be smaller than or equal to 50.');
        }
