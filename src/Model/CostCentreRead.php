...
/**
 * CostCentreRead Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CostCentreRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CostCentreRead';
    ...
    protected static array $openAPITypes = [
        ...
        'isActive' => 'bool',
        'resources' => '\SynergiTech\Iplicit\Model\CostCentreResource[]',
        'subCostCentres' => '\SynergiTech\Iplicit\Model\CostCentreSummary[]'
    ];
    ...
    protected static array $setters = [
        ...
        'subCostCentres' => 'setSubCostCentres'
    ];
    ...
    protected static array $getters = [
        ...
        'subCostCentres' => 'getSubCostCentres'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('subCostCentres', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Unique code for the cost centre
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the cost centre
     *
     * @return $this
     */
     ...
     *
     * @param string|null $parentCostCentreId The cost centre parent (where specified) can be useful for analytics
     *
     * @return $this
     */
     ...
     * Gets resources
     *
     * @return \SynergiTech\Iplicit\Model\CostCentreResource[]|null
     */
     ...
     * Sets resources
     *
     * @param \SynergiTech\Iplicit\Model\CostCentreResource[]|null $resources The cost centre resources
     *
     * @return $this
     */
     ...
     * Gets subCostCentres
     *
     * @return \SynergiTech\Iplicit\Model\CostCentreSummary[]|null
     */
    public function getSubCostCentres(): ?array
    {
        return $this->container['subCostCentres'];
    }

    /**
     * Sets subCostCentres
     *
     * @param \SynergiTech\Iplicit\Model\CostCentreSummary[]|null $subCostCentres The cost centre sub cost centres
     *
     * @return $this
     */
    public function setSubCostCentres(?array $subCostCentres): static
    {
        if (is_null($subCostCentres)) {
            array_push($this->openAPINullablesSetToNull, 'subCostCentres');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('subCostCentres', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['subCostCentres'] = $subCostCentres;
