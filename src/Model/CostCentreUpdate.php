...
/**
 * CostCentreUpdate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CostCentreUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CostCentreUpdate';
    ...
    */
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling CostCentreUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setLegacyRef(?string $legacyRef): static
    {
        ...
        if (!is_null($legacyRef) && (mb_strlen($legacyRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $legacyRef when calling CostCentreUpdate., must be smaller than or equal to 50.');
        }
