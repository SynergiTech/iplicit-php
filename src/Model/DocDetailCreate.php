...
/**
 * DocDetailCreate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DocDetailCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DocDetailCreate';
    ...
    */
    ...
    public function setProductId(?string $productId): static
    {
        ...
        if (!is_null($productId) && (mb_strlen($productId) > 50)) {
            throw new InvalidArgumentException('invalid length for $productId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductSkuId(?string $productSkuId): static
    {
        ...
        if (!is_null($productSkuId) && (mb_strlen($productSkuId) > 50)) {
            throw new InvalidArgumentException('invalid length for $productSkuId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProjectId(?string $projectId): static
    {
        ...
        if (!is_null($projectId) && (mb_strlen($projectId) > 50)) {
            throw new InvalidArgumentException('invalid length for $projectId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setTaxCodeId(?string $taxCodeId): static
    {
        ...
        if (!is_null($taxCodeId) && (mb_strlen($taxCodeId) > 50)) {
            throw new InvalidArgumentException('invalid length for $taxCodeId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setUomId(?string $uomId): static
    {
        ...
        if (!is_null($uomId) && (mb_strlen($uomId) > 50)) {
            throw new InvalidArgumentException('invalid length for $uomId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setAccountId(?string $accountId): static
    {
        ...
        if (!is_null($accountId) && (mb_strlen($accountId) > 50)) {
            throw new InvalidArgumentException('invalid length for $accountId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setTaxBandId(?string $taxBandId): static
    {
        ...
        if (!is_null($taxBandId) && (mb_strlen($taxBandId) > 50)) {
            throw new InvalidArgumentException('invalid length for $taxBandId when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new InvalidArgumentException('invalid length for $description when calling DocDetailCreate., must be smaller than or equal to 250.');
        }
     ...
     *
     * @param float|null $grossCurrencyUnitPrice The document detail gorss currency unit price
     *
     * @return $this
     */
    ...
    public function setIntRef(?string $intRef): static
    {
        ...
        if (!is_null($intRef) && (mb_strlen($intRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $intRef when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setLegacyRef(?string $legacyRef): static
    {
        ...
        if (!is_null($legacyRef) && (mb_strlen($legacyRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $legacyRef when calling DocDetailCreate., must be smaller than or equal to 50.');
        }
