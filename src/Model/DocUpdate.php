    ...
    */
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling DocUpdate., must be smaller than or equal to 3.');
        }
     ...
     * Sets currencyRate
     *
     * @param float|null $currencyRate The document curerncy rate
     *
     * @return $this
     */
     ...
     * Sets details
     *
     * @param \SynergiTech\Iplicit\Model\DocDetailUpdate[]|null $details The document detail itemms
     *
     * @return $this
     */
