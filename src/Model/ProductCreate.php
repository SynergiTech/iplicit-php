...
class ProductCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductCreate';
    ...
    protected static array $openAPITypes = [
        ...
        'purchase' => '\SynergiTech\Iplicit\Model\ProductPurchaseCreate',
        'sale' => '\SynergiTech\Iplicit\Model\ProductSaleCreate',
        'stock' => '\SynergiTech\Iplicit\Model\ProductStockCreate'
    ];
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The `Code` must be unique.
     *
     * @return $this
     */
    public function setCode(string $code): static
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new InvalidArgumentException('invalid length for $code when calling ProductCreate., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new InvalidArgumentException('invalid length for $code when calling ProductCreate., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 250)) {
            throw new InvalidArgumentException('invalid length for $description when calling ProductCreate., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling ProductCreate., must be bigger than or equal to 1.');
        }
    ...
    public function setProductGroupId(?string $productGroupId): static
    {
        ...
        if (!is_null($productGroupId) && (mb_strlen($productGroupId) > 50)) {
            throw new InvalidArgumentException('invalid length for $productGroupId when calling ProductCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductType(?string $productType): static
    {
        ...
        if (!is_null($productType) && (mb_strlen($productType) > 1)) {
            throw new InvalidArgumentException('invalid length for $productType when calling ProductCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setUomId(?string $uomId): static
    {
        ...
        if (!is_null($uomId) && (mb_strlen($uomId) > 50)) {
            throw new InvalidArgumentException('invalid length for $uomId when calling ProductCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setUomGroupId(?string $uomGroupId): static
    {
        ...
        if (!is_null($uomGroupId) && (mb_strlen($uomGroupId) > 50)) {
            throw new InvalidArgumentException('invalid length for $uomGroupId when calling ProductCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setLegacyRef(?string $legacyRef): static
    {
        ...
        if (!is_null($legacyRef) && (mb_strlen($legacyRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $legacyRef when calling ProductCreate., must be smaller than or equal to 50.');
        }
     ...
     * Gets purchase
     *
     * @return \SynergiTech\Iplicit\Model\ProductPurchaseCreate|null
     */
    public function getPurchase(): ?\SynergiTech\Iplicit\Model\ProductPurchaseCreate
    {
     ...
     * Sets purchase
     *
     * @param \SynergiTech\Iplicit\Model\ProductPurchaseCreate|null $purchase purchase
     *
     * @return $this
     */
    public function setPurchase(?\SynergiTech\Iplicit\Model\ProductPurchaseCreate $purchase): static
    {
        if (is_null($purchase)) {
     ...
     * Gets sale
     *
     * @return \SynergiTech\Iplicit\Model\ProductSaleCreate|null
     */
    public function getSale(): ?\SynergiTech\Iplicit\Model\ProductSaleCreate
    {
     ...
     * Sets sale
     *
     * @param \SynergiTech\Iplicit\Model\ProductSaleCreate|null $sale sale
     *
     * @return $this
     */
    public function setSale(?\SynergiTech\Iplicit\Model\ProductSaleCreate $sale): static
    {
        if (is_null($sale)) {
     ...
     * Gets stock
     *
     * @return \SynergiTech\Iplicit\Model\ProductStockCreate|null
     */
    public function getStock(): ?\SynergiTech\Iplicit\Model\ProductStockCreate
    {
     ...
     * Sets stock
     *
     * @param \SynergiTech\Iplicit\Model\ProductStockCreate|null $stock stock
     *
     * @return $this
     */
    public function setStock(?\SynergiTech\Iplicit\Model\ProductStockCreate $stock): static
    {
        if (is_null($stock)) {
