...
/**
 * ProductPurchasePriceCreate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProductPurchasePriceCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductPurchasePriceCreate';
    ...
    */
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ProductPurchasePriceCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setUnitOfMeasureRef(?string $unitOfMeasureRef): static
    {
        ...
        if (!is_null($unitOfMeasureRef) && (mb_strlen($unitOfMeasureRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $unitOfMeasureRef when calling ProductPurchasePriceCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setSupplierRef(?string $supplierRef): static
    {
        ...
        if (!is_null($supplierRef) && (mb_strlen($supplierRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $supplierRef when calling ProductPurchasePriceCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProjectRef(?string $projectRef): static
    {
        ...
        if (!is_null($projectRef) && (mb_strlen($projectRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $projectRef when calling ProductPurchasePriceCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductPriceBandRef(?string $productPriceBandRef): static
    {
        ...
        if (!is_null($productPriceBandRef) && (mb_strlen($productPriceBandRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productPriceBandRef when calling ProductPurchasePriceCreate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductSKURef(?string $productSKURef): static
    {
        ...
        if (!is_null($productSKURef) && (mb_strlen($productSKURef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productSKURef when calling ProductPurchasePriceCreate., must be smaller than or equal to 50.');
        }
