...
/**
 * ProductPurchasePriceRead Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProductPurchasePriceRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductPurchasePriceRead';
    ...
    protected static array $setters = [
        'id' => 'setId',
        'productPurchaseId' => 'setProductPurchaseId',
    ...
    protected static array $getters = [
        'id' => 'getId',
        'productPurchaseId' => 'getProductPurchaseId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('productPurchaseId', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Product Purchase Price Unique Identifier.
     *
     * @return $this
     */
    ...
    /**
     * Gets productPurchaseId
     *
     * @return string|null
     */
    public function getProductPurchaseId(): ?string
    {
        return $this->container['productPurchaseId'];
    }

    /**
     * Sets productPurchaseId
     *
     * @param string|null $productPurchaseId Id of Product Purchase for select price.
     *
     * @return $this
     */
    public function setProductPurchaseId(?string $productPurchaseId): static
    {
        if (is_null($productPurchaseId)) {
            throw new InvalidArgumentException('non-nullable productPurchaseId cannot be null');
        }
        $this->container['productPurchaseId'] = $productPurchaseId;
     ...
     * Sets supplierId
     *
     * @param string|null $supplierId Product price supplier id.
     *
     * @return $this
     */
     ...
     * Sets isActive
     *
     * @param bool|null $isActive Is the product purchase price active
     *
     * @return $this
     */
     ...
     * Sets priceRef
     *
     * @param string|null $priceRef Product purchase price Reference
     *
     * @return $this
     */
     ...
     *
     * @param string|null $productPriceBandId Product Purchase Price Band
     *
     * @return $this
     */
     ...
     * Sets lastModified
     *
     * @param \DateTime|null $lastModified Date and time the product purchase price was last modified.
     *
     * @return $this
     */
     ...
     * Sets lastModifiedBy
     *
     * @param string|null $lastModifiedBy The user who last modified the product purchase price.
     *
     * @return $this
     */
