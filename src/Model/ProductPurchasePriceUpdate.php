...
/**
 * ProductPurchasePriceUpdate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProductPurchasePriceUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductPurchasePriceUpdate';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supplierRef', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['supplierRef']) && (mb_strlen($this->container['supplierRef']) > 50)) {
            $invalidProperties[] = "invalid value for 'supplierRef', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ProductPurchasePriceUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setQuantityFrom(?float $quantityFrom): static
    {
        if (is_null($quantityFrom)) {
            array_push($this->openAPINullablesSetToNull, 'quantityFrom');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quantityFrom', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $unitOfMeasureRef Unit of measure (id or code).  See catalog `Unit` for possible values.
     *
     * @return $this
     */
    public function setUnitOfMeasureRef(?string $unitOfMeasureRef): static
    {
        ...
        if (!is_null($unitOfMeasureRef) && (mb_strlen($unitOfMeasureRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $unitOfMeasureRef when calling ProductPurchasePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    {
        return $this->container['supplierRef'];
    }

    /**
     * Sets supplierRef
     *
     * @param string|null $supplierRef Product price supplier id or code.
     *
     * @return $this
     */
    public function setSupplierRef(?string $supplierRef): static
    {
        if (is_null($supplierRef)) {
            array_push($this->openAPINullablesSetToNull, 'supplierRef');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplierRef', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($supplierRef) && (mb_strlen($supplierRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $supplierRef when calling ProductPurchasePriceUpdate., must be smaller than or equal to 50.');
        }

        $this->container['supplierRef'] = $supplierRef;
    ...
    public function setProjectRef(?string $projectRef): static
    {
        ...
        if (!is_null($projectRef) && (mb_strlen($projectRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $projectRef when calling ProductPurchasePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductPriceBandRef(?string $productPriceBandRef): static
    {
        ...
        if (!is_null($productPriceBandRef) && (mb_strlen($productPriceBandRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productPriceBandRef when calling ProductPurchasePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductSKURef(?string $productSKURef): static
    {
        ...
        if (!is_null($productSKURef) && (mb_strlen($productSKURef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productSKURef when calling ProductPurchasePriceUpdate., must be smaller than or equal to 50.');
        }
