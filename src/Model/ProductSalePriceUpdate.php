...
/**
 * ProductSalePriceUpdate Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProductSalePriceUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductSalePriceUpdate';
    ...
    */
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 5)) {
            throw new InvalidArgumentException('invalid length for $currency when calling ProductSalePriceUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setUnitOfMeasureRef(?string $unitOfMeasureRef): static
    {
        ...
        if (!is_null($unitOfMeasureRef) && (mb_strlen($unitOfMeasureRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $unitOfMeasureRef when calling ProductSalePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setCustomerRef(?string $customerRef): static
    {
        ...
        if (!is_null($customerRef) && (mb_strlen($customerRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $customerRef when calling ProductSalePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setProjectRef(?string $projectRef): static
    {
        ...
        if (!is_null($projectRef) && (mb_strlen($projectRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $projectRef when calling ProductSalePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductPriceBandRef(?string $productPriceBandRef): static
    {
        ...
        if (!is_null($productPriceBandRef) && (mb_strlen($productPriceBandRef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productPriceBandRef when calling ProductSalePriceUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setProductSKURef(?string $productSKURef): static
    {
        ...
        if (!is_null($productSKURef) && (mb_strlen($productSKURef) > 50)) {
            throw new InvalidArgumentException('invalid length for $productSKURef when calling ProductSalePriceUpdate., must be smaller than or equal to 50.');
        }
