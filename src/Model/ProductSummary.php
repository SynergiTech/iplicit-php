...
class ProductSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('isPurchase', $data ?? [], null);
        $this->setIfExists('isSale', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['isPurchase'];
    }

    /**
     * Sets isPurchase
     *
     * @param bool|null $isPurchase Is product available for purchase transactions
     *
     * @return $this
     */
    public function setIsPurchase(?bool $isPurchase): static
    {
        if (is_null($isPurchase)) {
            throw new InvalidArgumentException('non-nullable isPurchase cannot be null');
        }
        $this->container['isPurchase'] = $isPurchase;
    ...
    {
        return $this->container['isSale'];
    }

    /**
     * Sets isSale
     *
     * @param bool|null $isSale Is product available for sale transactions
     *
     * @return $this
     */
    public function setIsSale(?bool $isSale): static
    {
        if (is_null($isSale)) {
            throw new InvalidArgumentException('non-nullable isSale cannot be null');
        }
        $this->container['isSale'] = $isSale;
