...
/**
 * ProjectChild Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProjectChild implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProjectChild';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The child project unique id
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string|null $code The child project code
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description The child project description
     *
     * @return $this
     */
