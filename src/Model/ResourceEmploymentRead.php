...
/**
 * ResourceEmploymentRead Class Doc Comment
 *
 * @package  SynergiTech\Iplicit
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResourceEmploymentRead implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResourceEmploymentRead';
    ...
    */
     ...
     * Sets legalEntityId
     *
     * @param string|null $legalEntityId Resource employment legal entity id
     *
     * @return $this
     */
     ...
     *
     * @param string|null $employmentTypeId Resource employment type id
     *
     * @return $this
     */
    ...
    public function setJobTitle(?string $jobTitle): static
    {
        ...
        if (!is_null($jobTitle) && (mb_strlen($jobTitle) > 50)) {
            throw new InvalidArgumentException('invalid length for $jobTitle when calling ResourceEmploymentRead., must be smaller than or equal to 50.');
        }
    ...
    public function setJobGrade(?string $jobGrade): static
    {
        ...
        if (!is_null($jobGrade) && (mb_strlen($jobGrade) > 50)) {
            throw new InvalidArgumentException('invalid length for $jobGrade when calling ResourceEmploymentRead., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param string|null $paymentFrequencyId Resource employment payment frequency id
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $excludeFromIntermediaryReport Resource employment exclude from intermediary report
     *
     * @return $this
     */
    public function setExcludeFromIntermediaryReport(?bool $excludeFromIntermediaryReport): static
    {
        if (is_null($excludeFromIntermediaryReport)) {
            throw new InvalidArgumentException('non-nullable excludeFromIntermediaryReport cannot be null');
        }
    ...
    public function setExternalReference(?string $externalReference): static
    {
        ...
        if (!is_null($externalReference) && (mb_strlen($externalReference) > 50)) {
            throw new InvalidArgumentException('invalid length for $externalReference when calling ResourceEmploymentRead., must be smaller than or equal to 50.');
        }
